...
insert into  Clients (Fname, Minit, Lname, CPF, Address)
  ...
  -- idProduct, Pname, classification_kids boolean, category('Eletronico','Vestimenta','Briquendos','Alimentos','Móveis'), avaliação, size
  insert into product (Pname, classification_kids, category, avaliação, size) values
	...
	-- idOrderm idOrderClient, orderStatus, orderDescriptionm sendValue, paymentCast
    insert into orders (idOrderClient, orderStatus, orderDescription, sendValue, paymentCast) values
				(1, null, 'compra via aplicativo',null,1),
                (2, null,'compra via aplicativo',50,0),
                (3,'Confirmardo',null,null,1),
...
-- id Supplier, SocialName,CNPJ, contact
insert into supplier (SocialName, CNPJ, contact) values
			('Almeida e filhos',123456789123456,'21985474'),
            ('Eletrônicos Silva',854519649143457,'21985484'),
            ('Eletrônicos Valma',934567893934695,'2197574');
            
select * from supplier;
-- idPsSupplier, idPsProdutct, quantity
...
insert into seller (SocialName, AbstName, CNPJ, CPF, location, contact) values
 ...
 insert into productSeller (idPsellerm ,idPproduct,prodQuantity) values
			(1,6,80),
            (2,7,10);
